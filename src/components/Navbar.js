  ...
  OS
            ...
            <span className="navbar-text">
              <div className="social-icon">
                ...
                <a rel="noreferrer" target="_blank" href="https://twitter.com/durdana_dee"><img src={navIcon2} alt="Twitter" /></a>
                <a rel="noreferrer" target="_blank" href="https://github.com/RitaDee"><img src={navIcon3} alt="GitHub" className="git"/></a>
              </div>
              <HashLink to='#connect'>
